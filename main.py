...
class Bullet(arcade.Sprite):
    def __init__(self, position, velocity, damage):
        ...
        Parameters: position: (x,y) tuple
            ...
            damage: int (or float)
        '''
        super().__init__("assets/laserBlue06.png", 0.5)
...
class Player(arcade.Sprite):
    def __init__(self):
        super().__init__("assets/playerShip2_orange.png", 0.5)
...
class Window(arcade.Window):
    ...
    def update(self, delta_time):
        ...
        for e in self.enemy_list:
            if random.randrange(200) == 0:
                bullet = arcade.Sprite("assets/laserRed01.png")
                bullet.center_x = e.center_x
                bullet.angle = -180
                bullet.top = e.bottom
                bullet.change_y = -2
    ...
    def on_draw(self):
        ...
        if len(self.enemy_list) == 0 :
            arcade.draw_text('Game over. You won. Now prepare for midterms', 300,SCREEN_HEIGHT - 160, arcade.color.WHITE, 15)
